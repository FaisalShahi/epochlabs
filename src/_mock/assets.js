...
export const _faqQuestions = [
  'What services does your IT company provide?',
  'How can I request a quote for my project?',
  'What industries do you cater to for your IT solutions?',
  'How experienced is your team?',
  'What is the typical timeline for completing a project?',
  'Can you help with ongoing support and maintenance after the project is completed?',
  'What technologies do you specialize in?',
  'Do you work with startups or established businesses?',
  'How do you ensure the security of custom software solutions?',
  'What is your approach to client collaboration during the development process?'
]

export const _descriptions = [
  `We offer a comprehensive range of IT services, including design, development, and tailored solutions for businesses of all sizes.`,
  `To receive a quote, simply visit our "Contact" page and provide details about your project requirements. Our team will promptly assess the scope and schedule a meeting for better understanding of your requirements and needs.`,
  `Our IT solutions cater to a diverse range of industries, ensuring that our services can be customized to meet the unique needs of various business sectors.`,
  `Our team comprises seasoned professionals with extensive experience in design, development, and delivering high-quality software solutions.`,
  `Project timelines vary based on factors such as complexity and client requirements. We work closely with clients to establish realistic timelines and ensure timely project delivery.`,
  `Yes, we provide post-development support, updates, and maintenance to ensure the continued success and functionality of your software.`,
  `Our team specializes in a wide range of technologies and programming languages to deliver cutting-edge solutions tailored to your specific needs.`,
  `We work with clients of all sizes, from startups to established enterprises. Our services are scalable to meet the unique requirements of businesses at various stages of development.`,
  `Security is a top priority for us. We implement robust measures to safeguard the confidentiality and integrity of the software we develop, adhering to industry best practices.`,
  `We prioritize transparent communication and collaboration. Clients are actively involved throughout the development process, with regular updates, feedback opportunities, and clear channels for communication with our team.`,
];
